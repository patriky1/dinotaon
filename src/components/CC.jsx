        ...
        <Row>
          <Col lg={6} className="ConteudoCity">
            ...
            <p className="textCity">
              ...
              <p className="textCity">
                Localizado em um prédio histórico que respira cultura e
                história, o Centro Cultural Banco do Nordeste em Sousa é um
                ponto de encontro para amantes da arte, estudantes ávidos por
                conhecimento e comunidades em busca de atividades culturais
                enriquecedoras.
              </p>
              <p className="textCity">
                Aqui, você encontrará exposições de arte contemporânea que
                desafiam a mente e inspiram a criatividade. Há também
              ...
              <p className="textCity">
                O Centro Cultural Banco do Nordeste em Sousa-PB é um convite
                para explorar, aprender e se encantar. Junte-se a nós e mergulhe
                em um mundo de cultura, arte e aprendizado. Venha conhecer este
                rico cenário cultural em Sousa!
              </p>
            </p>
          </Col>
          <Col lg={6}>

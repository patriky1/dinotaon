  ...
  return (
    <>
      ...
      <Container fluid className="mt-5 ">
        <Row>
          <Col lg={5} className="ConteudoCity">
            ...
            <p className="textCity "></p>
            <p className="textCity ">
              O açude de São Gonçalo é uma verdadeira joia da região. Suas águas
              cristalinas não apenas abastecem a cidade, mas também proporcionam
              um cenário espetacular para os moradores locais e visitantes.
            </p>
            <p className="textCity ">
              A devoção religiosa é uma parte central da vida em São Gonçalo. A
              Igreja de São Gonçalo, padroeiro do distrito, é um ponto de
              encontro espiritual para a comunidade local. Durante as
            ...
            <p className="textCity ">
              A tranquilidade de São Gonçalo é um contraste bem-vindo para
              aqueles que buscam escapar da agitação da vida moderna. Aqui, os
              visitantes podem experimentar a autêntica cultura sertaneja, desde
              a culinária típica até as tradições musicais e culturais que
              permeiam a vida cotidiana.
            </p>
            <p className="textCity ">
              O pôr do sol em São Gonçalo é um espetáculo à parte e um

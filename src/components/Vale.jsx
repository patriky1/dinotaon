        ...
        <Row>
          <Col lg={6} className="ConteudoCity">
            ...
            <p className="textCity ">
              ...
              dos dinossauros.
              <p className="textCity ">
              O Vale é uma verdadeira cápsula do tempo
              ...
              emocionante para todas as idades.</p>

              <p className="textCity ">
              O Vale dos Dinossauros em Sousa-PB, é um destino que

      ...
      <Container fluid className="mt-5 ">
        <Row>
          <Col lg={5} className="ConteudoCity">
            ...
            <p className="textCity ">
              O memorial oferece aos visitantes a oportunidade de conhecer mais
              sobre a vida e obra de Antônio Mariz por meio de exposições,
              documentos históricos, fotografias e objetos relacionados à sua
              vida e carreira. É um espaço de valorização da cultura local e de
              resgate da história, permitindo que as gerações atuais e futuras
              compreendam a importância desse ilustre paraibano.
            </p>
            <p className="textCity ">
              É um local que convida os visitantes a mergulhar na rica herança
              cultural e política da cidade e do estado.
            </p>
            <p className="textCity ">
